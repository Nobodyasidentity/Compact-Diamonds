...
<img src="https://cdn.modrinth.com/data/ycBtoWql/images/7b5a1df259250d0cf64d5c75ee296f97c211f9b2.png" alt="Crafting a Compact Block of Diamond">
...
The **Compact Block of Diamond** can be carried in stacks of 64 or placed on the ground
### One Compact Block of Diamond is the equivalent to <ins>81 diamonds</ins>.

# How to install?
## Vanilla [Datapack]:
1. Download the latest [release for vanilla](https://modrinth.com/datapack/compact-diamonds?loader=datapack#download).
2. Open Minecraft.
3. Select the world you want to install the data pack for, click on "Edit", then "Open world folder".
    > ### ⚠ Server note:  
    > For a server, simply find the folder in the server called "world".
4. Open the folder named `datapacks`, and put the datapack into it. The datapack should be a `.zip` file.
5. If you are in the world during the installation, type `/reload` (if you have enabled cheats) or press `F3`+`T`.
6. If the datapack was installed correctly, it should be enabled in the world. If you have enabled cheats, you can verify by typing `/datapack list enabled` and find an entry named `[file/Compact-Diamonds.zip]`.
